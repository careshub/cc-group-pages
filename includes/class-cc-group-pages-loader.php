...
class CC_Group_Pages_Loader {
	...
	public function add_action( $hook, $component, $callback, $priority = 10, $accepted_args = 1 ) {
		...
		$this->actions = $this->add( $this->actions, 'init', 'CC_Group_Pages_CPT_Tax', 'register_cpt', 12, $accepted_args );
		// Register the custom taxonomy
		$this->actions = $this->add( $this->actions, 'init', 'CC_Group_Pages_CPT_Tax', 'register_taxonomy', 12, $accepted_args );
	}
